...
private Juego juego;
    ...
    juego.generarNuevoEnemigo();
        int expected = 70;
        assertEquals(expected, this.jugador.getArmaPrimaria().atacarEnemigo(enemigo,inventario));
    ...
    public void restarMunicion() {
        int expected = 15;
        assertEquals(expected, this.jugador.getArmaPrimaria().restarMunicion(inventario));
    }
}